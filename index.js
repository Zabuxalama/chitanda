...
function title() {
      console.clear()
	  console.log(chalk.bold.green(figlet.textSync('MiawBot MD', {
		font: 'Standard',
	...
	console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Created By Awy_ ]')}\n\n${chalk.red('Miaw')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta Dev')} : ${chalk.white('@Alwiiyy__')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+62 856-5337-357')}\n${chalk.red('Donate')} : ${chalk.white('08565337357 ( Ovo/Pulsa/Dana )')}\n`))
}
